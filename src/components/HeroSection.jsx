    ...
    <>
      <section className="flex flex-col-reverse md:flex-row items-center justify-between md:mt-20">
          <div className="md:w-1/2 p-12">
              ...
              <h1 className="text-4xl md:text-4xl sm:text-5xl font-bold text-gray-900 mb-4">I'm Dianna Adams</h1>
      ...
      <div className='py-20'>
          ...
          <section className="bg-white flex flex-wrap justify-around ">
              <div className="">
                  <img src="https://websitedemos.net/food-blogger-04/wp-content/uploads/sites/793/2021/03/food-blogger-featured-in-logo-1.svg" className="attachment-full h-24"/>
              </div>
              <div className="">
                  <img decoding="async" width="177" height="100" src="https://websitedemos.net/food-blogger-04/wp-content/uploads/sites/793/2021/03/food-blogger-featured-in-logo-2.svg" className="attachment-full size-full wp-image-21" alt=""/>
              </div>
              <div className="">
              ...
              <div className="elementor-widget-container">
                  <img loading="lazy" decoding="async" width="177" height="100" src="https://websitedemos.net/food-blogger-04/wp-content/uploads/sites/793/2021/03/food-blogger-featured-in-logo-3.svg" className="attachment-full size-full wp-image-22" alt=""/>
              </div>
          </section>
      </div>
    </>
